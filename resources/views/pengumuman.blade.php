...
@if(isset($peserta))
    @php
        ...
        $ogDesc = strtoupper($peserta->nama) . ' ' . $statusStr . ' Seleksi Administrasi MNCU Future Leader Scholarship 2026. Cek hasil lengkapnya di sini.';
    @endphp
    @push('meta')
...
@if(isset($peserta))
    @php
        ...
        $shareDesc = strtoupper($peserta->nama) . " dinyatakan " . $statusText . " Seleksi Administrasi MNCU Future Leader Scholarship 2026. Cek hasil lengkapnya di sini.";
    @endphp
    @push('meta')
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-8">
                <div class="text-center">
                    ...
                    <p class="text-blue-100">MNCU Future Leader Scholarship 2026</p>
                </div>
            </div>
                ...
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mb-8">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-blue-800 text-sm">Masukkan NISN Anda untuk melihat hasil seleksi administrasi berkas MNCU Future Leader Scholarship 2026. Pastikan NISN yang dimasukkan sesuai dengan data yang Anda daftarkan.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-sm">Hasil Seleksi Administrasi MNCU Future Leader Scholarship 2026</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8">
                <div class="mb-8">
                    ...
                    <div class="text-center mb-6">
                        ...
                        <p class="text-gray-600">MNCU Future Leader Scholarship 2026</p>
                ...
                <div class="border-t border-gray-200 pt-6">
                    <div class="text-center text-sm text-gray-600">
                        ...
                        <p class="mb-4">Untuk informasi lebih lanjut, hubungi Panitia MNCU Future Leader Scholarship 2026</p>
...
doc.setFont("times","normal");
doc.setFontSize(11);
doc.text("MNCU Future Leader Scholarship 2026",105,y,{align:"center"});
...
"Panitia Seleksi MNCU Future Leader Scholarship 2026 dengan ini menerangkan bahwa:",
contentWidth
);
...
y += 5;
doc.text("Panitia Beasiswa MNCU Future Leader Scholarship 2026", marginRight - 50, y, {align:"left"});
...
async function shareResult(name, status) {
    const shareData = {
        text: `Saya ${name} dinyatakan ${status} Seleksi Administrasi Berkas MNCU Future Leader Scholarship 2026!`,
