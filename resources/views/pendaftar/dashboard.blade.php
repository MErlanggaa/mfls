...
<div class="space-y-8">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-green-500 to-green-600 p-6 rounded-2xl shadow-xl">
        <div class="flex items-center gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-white font-bold text-lg mb-1">Bergabung dengan Grup WhatsApp MFLS 2026!</h3>
                <p class="text-green-100 text-sm mb-3">Dapatkan info terbaru, tips, dan terhubung dengan sesama peserta beasiswa</p>
                <a href="https://chat.whatsapp.com/CemfyneCf8U30hN5uyXL1e?mode=gi_t" target="_blank" class="inline-flex items-center gap-2 bg-white text-green-600 px-4 py-2 rounded-lg font-bold text-sm hover:bg-green-50 transition-colors">
            ...
            <button onclick="this.parentElement.parentElement.style.display='none'" class="text-white/70 hover:text-white">
