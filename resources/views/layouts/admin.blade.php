    ...
    <div class="flex min-h-screen">
        ...
        <aside id="adminSidebar"
            ...
            <nav class="flex-grow px-4 pb-4 space-y-1 overflow-y-auto mt-4">
                ...
                @if((auth()->user()->role === 'admin' || auth()->user()->role === 'panitia') && auth()->user()->email === 'dion@gmail.com')
                ...
                @if(auth()->check() && (auth()->user()->role === 'admin' || in_array(auth()->user()->email, ['dion@gmail.com', 'adminis@mfls.com'])))
                ...
                @if(in_array(auth()->user()->email, ['dion@gmail.com', 'adminis@mfls.com']))
